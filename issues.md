...
<section id="one">
	<div class="inner">
		...
		<p>Most Americans know that our country is facing incredible problems right now. It's no secret. Nor is it news that the core root of all these problems is 'money'. What maybe isn't so clear, however, is specifically <b>how</b> money factors into them, or just how severe the situation is. Listed here are brief summaries of the four main threats to our economic and societal stability. These are the largest sources of disaster to nearly all Americans, explained in brief detail with links to provide greater depth and evidence. Each summary is accompanied by a button leading to more detailed dissections of the current effects of these issues and their causes. Each of these, in turn, contains a series of solutions that, according to a great many skilled professionals, have real promise and backing.<br /><br />
